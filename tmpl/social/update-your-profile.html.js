...
module.exports = () => page({
  tab: 'social',
  path: '/social/update-your-profile.html',
  content: `
    <p>
    ...
    <p>
      ...
      First, <a href="/basics/publish-a-file.html">add the image file to the blobstore.</a>
      Then, publish this message with the output hash.
    </p>
    ${ com.code({ js: jsSnippet2, bash: bashSnippet2 }) }

    <p class="next"><a href="/social/join-a-pub.html">Join a pub</a></p>
    <ul class="see-also">
      <li><a href="/basics/publish-a-file.html">Publish a file</a></li>
