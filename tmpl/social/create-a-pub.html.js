...
module.exports = () => page({
  tab: 'social',
  path: '/social/create-a-pub.html',
  content: `
    <p>
      <em>Note, this guide assumes moderate technical ability.</em>
    </p>
...
while true; do
  sbot server --host {your-hostname}
    ...
    <p class="next"><a href="/advanced/writing-applications.html">Writing Applications</a></p>
    <ul class="see-also">
