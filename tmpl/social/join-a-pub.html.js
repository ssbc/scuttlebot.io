...
module.exports = () => page({
  ...
  content: `
    ...
    <h2>Join a Pub</h2>
    <p>
      First get an invite-code from a Pub operator, or <a href="/social/create-a-pub.html">create your own pub.</a>
      Then:
    </p>
    ...
    <p class="next"><a href="/social/create-a-pub.html">Create a Pub</a></p>
    <ul class="see-also">
